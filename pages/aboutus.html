   ...
   ========================================= */
        ...
        #hero {
            background: linear-gradient(rgba(0, 0, 0, 0.55),
                    rgba(0, 0, 0, 0.65)),
                url("../images/index_slider_iamges/index_slider_1.jpg") center / cover no-repeat;
            color: #fff;
            min-height: 80vh;
            display: flex;
            align-items: center;
...
<body class="bg-light">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item d-flex align-items-center gap-1" href="#"><img
                                    src="../images/Flag_of_the_United_States.svg.webp" width="30" height="20"
                                    alt="">EN</a>
                        </li>
                        <li><a class="dropdown-item d-flex align-items-center gap-1" href="#"><img
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a href="../index.html" class="d-flex align-items-center"><img src="../images/logo.png" width="70"
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto gap-3">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="aboutus.html">ჩვენს შესახებ</a></li>
        ...
        <header id="hero" class="py-5 py-lg-6 position-relative overflow-hidden" role="banner"
            ...
            <div class="container hero__container position-relative z-2 text-center text-lg-start">
                ...
                <div
                    ...
                    <a href="contact.html" class="btn btn-primary btn-lg px-4">
                        შეთავაზების მიღება
                    </a>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <div class="position-relative">
                            <img src="../images/truck-1.jpg" alt="KKK & Company ლოჯისტიკური ცენტრი და გუნდი"
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-md-4">
                        <div class="shadow-sm bg-white p-2 h-100 d-flex align-items-center justify-content-center">
                            <img src="../images/certificate/1.jpg" class="img-fluid" style="max-height: 300px;" alt="">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="shadow-sm bg-white p-2 h-100 d-flex align-items-center justify-content-center">
                            <img src="../images/certificate/2.jpg" class="img-fluid" style="max-height: 300px;" alt="">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="shadow-sm bg-white p-2 h-100 d-flex align-items-center justify-content-center">
                            <img src="../images/certificate/3.jpg" class="img-fluid" style="max-height: 300px;" alt="">
                        </div>
                    </div>
                </div>
            </div>
