...
<head>
    ...
    <title>კონტაქტი - კკკ & კომპანია | Contact</title>
    <meta name="description" content="დაგვიკავშირდით - კკკ & კომპანია. სატვირთო მანქანების შეძენა, გადაზიდვები და ლოჯისტიკური მომსახურება">
...
<body class="bg-light">
            ...
            <div class="d-flex gap-3 align-items-center">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item d-flex align-items-center gap-1" href="#"><img src="../images/Flag_of_the_United_States.svg.webp" width="30" height="20" alt="">EN</a></li>
                        <li><a class="dropdown-item d-flex align-items-center gap-1" href="#"><img src="../images/Flag_of_Georgia.svg.png" width="30" height="20" alt="">KA</a></li>
                    </ul>
                </div>
                <div class="dropdown">
                    <button class="btn btn-sm btn-outline-dark d-flex align-items-center gap-1" type="button" data-bs-toggle="dropdown">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto gap-3">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="contact.html">კონტაქტი</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section class="py-5 bg-primary text-white text-center">
        <div class="container">
            <h1 class="display-4 fw-bold mb-3">დაგვიკავშირდით</h1>
            <p class="lead">ჩვენ მზად ვართ გიპასუხოთ თქვენს ყველა კითხვაზე</p>
        </div>
    </section>
    ...
    <section class="py-5" style="background-color: white;">
        <div class="container">
            <div class="row g-5">
                <!-- Contact Info -->
                <div class="col-lg-5">
                    <h2 class="fw-bold mb-4">კონტაქტის ინფორმაცია</h2>
                    ...
                    <div class="d-flex align-items-start mb-3">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="fw-bold mb-1">ტელეფონები</h5>
                            <p class="text-muted mb-0">
                                ფინანსური განყოფილება: <a href="tel:+995551047535" class="text-decoration-none text-muted">+995 551 04 75 35</a><br>
                                გაყიდვების მენეჯერი: <a href="tel:+995551458454" class="text-decoration-none text-muted">+995 551 45 84 54</a><br>
                                სერვის ცენტრის მენეჯერი: <a href="tel:+995599100577" class="text-decoration-none text-muted">+995 599 100 577</a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-start mb-3">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="fw-bold mb-1">ელ-ფოსტა</h5>
                            <p class="text-muted mb-0">
                    ...
                    <div class="d-flex align-items-start mb-3">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="fw-bold mb-1">მისამართები</h5>
                            <p class="text-muted mb-0">
                                ფოთი, წმ. გიორგის ქ. №11<br>
                    ...
                    <!-- Social Links -->
                    <div class="mt-3">
                        <h5 class="fw-bold mb-2">მოგვიყევით სოციალური ქსელებით</h5>
                ...
                <div class="col-lg-7">
                    <div class="card border-0 shadow p-4 p-md-5">
                        <h2 class="fw-bold mb-4">გაგვიგზავნეთ შეტყობინება</h2>
                        <form id="contactForm" novalidate>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label">სახელი *</label>
                                    <input type="text" class="form-control" name="name" placeholder="თქვენი სახელი" required>
                                    <div class="invalid-feedback">გთხოვთ შეიყვანოთ სახელი</div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="invalid-feedback">გთხოვთ შეიყვანოთ სწორი ელ-ფოსტა</div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="subject" required>
                                        ...
                                        <option value="truck-sale">სატვირთო მანქანის შეძენა</option>
                                        <option value="shipping">გადაზიდვის მოთხოვნა</option>
                                        <option value="customs">საბაჟო მომსახურება</option>
                                        <option value="consultation">კონსულტაცია</option>
                                        <option value="other">სხვა</option>
                                    </select>
                                    <div class="invalid-feedback">გთხოვთ აირჩიოთ თემა</div>
                                </div>
                                <div class="col-12">
                                    <label class="form-label">შეტყობინება *</label>
                                    <textarea class="form-control" rows="5" name="message" placeholder="მოგვწერეთ დეტალურად..." required></textarea>
                                    <div class="invalid-feedback">გთხოვთ შეიყვანოთ შეტყობინება</div>
                                </div>
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="privacy" required>
                                        <label class="form-check-label" for="privacy">
                                            ვეთანხმები <a href="#" class="text-primary">კონფიდენციალურობის პოლიტიკას</a>
                                        </label>
                                        <div class="invalid-feedback">გთხოვთ დაეთანხმოთ პოლიტიკას</div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary w-100 py-3">
                                        <i class="fa-solid fa-paper-plane me-2"></i>შეტყობინების გაგზავნა
                                    </button>
                                </div>
                                <div class="col-12">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <ul class="list-unstyled text-secondary">
                        <li class="mb-2"><a href="../index.html" class="text-decoration-none text-secondary">მთავარი</a></li>
                        <li class="mb-2"><a href="aboutus.html" class="text-decoration-none text-secondary">ჩვენს შესახებ</a></li>
                        <li class="mb-2"><a href="gallery.html" class="text-decoration-none text-secondary">გალერეა</a></li>
                        <li class="mb-2"><a href="blog.html" class="text-decoration-none text-secondary">ბლოგი</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <p class="text-secondary mb-2">
                        ...
                        ფინანსური განყოფილება: <br> +995 551 04 75 35
                    </p>
                    <p class="text-secondary mb-2">
                        <i class="fa-solid fa-phone me-2"></i>
                        გაყიდვების მენეჯერი: <br> +995 551 45 84 54
                    </p>
                    <p class="text-secondary mb-2">
                        <i class="fa-solid fa-phone me-2"></i>
                        სერვის ცენტრის მენეჯერი: <br> +995 599 100 577
                    </p>
                    <p class="text-secondary mb-2">
                ...
                <div class="col-lg-3">
                    ...
                    <p class="text-secondary mb-2"><i class="fa-solid fa-location-dot me-2"></i>ფოთი, 9 აპრილის ხეივანი №28</p>
                </div>
