...
<body class="bg-light">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="position-relative">
                        <img src="images/truck-1.jpg" class="img-fluid rounded shadow" alt="Our Logistics">
                        <div
                            ...
                            <p class="mb-0">წლის გამოცდილება</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 ps-lg-5">
                    <h6 class="text-primary fw-bold text-uppercase">ჩვენს შესახებ</h6>
                    <h2 class="display-6 fw-bold mb-4">საიმედო პარტნიორი ლოჯისტიკაში</h2>
                    <p class="lead text-muted">ჩვენ გთავაზობთ სრულ ლოჯისტიკურ მომსახურებას მთელი საქართველოსა და ევროპის
                        მასშტაბით.</p>
                    <p>ჩვენი კომპანია წლებია უზრუნველყოფს ტვირთების უსაფრთხო და სწრაფ გადაზიდვას. ჩვენი ავტოპარკი
                        აღჭურვილია თანამედროვე სტანდარტების მქონე სატვირთო ავტომობილებით, რაც გარანტიას იძლევა თქვენი
                        ტვირთის დაცულობაზე.</p>
                    <a href="pages/aboutus.html" class="btn btn-primary px-4 py-2 mt-3">გაიგეთ მეტი</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5 bg-light">
        <div class="container text-center mb-5">
            <h6 class="text-primary fw-bold text-uppercase">სერვისები</h6>
            <h2 class="fw-bold">რას ვთავაზობთ მომხმარებელს</h2>
        </div>
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card h-100 border-0 shadow-sm p-4 text-center service-card">
                        ...
                        <h5 class="fw-bold">სახმელეთო გადაზიდვები</h5>
                        <p class="small text-muted">
                            ტვირთების გადაზიდვა ევროპისა და აზიის მიმართულებით.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card h-100 border-0 shadow-sm p-4 text-center service-card">
                        ...
                        <h5 class="fw-bold">საზღვაო გადაზიდვები</h5>
                        <p class="small text-muted">
                            კონტეინერული და ტვირთების საზღვაო ტრანსპორტირება.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card h-100 border-0 shadow-sm p-4 text-center service-card">
                        ...
                        <h5 class="fw-bold">საბაჟო-საბროკერო მომსახურება</h5>
                        <p class="small text-muted">
                            დოკუმენტაცია და საბაჟო პროცედურების სრული მხარდაჭერა.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 ">
                    <div class="card h-100 border-0 shadow-sm p-4 text-center service-card">
                        ...
                        <h5 class="fw-bold">საკონტეინერო გადაზიდვები</h5>
                        <p class="small text-muted">
                            უსაფრთხო და ეფექტური კონტეინერული ლოჯისტიკა.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 service-wide">
                    <div class="card h-100 service-card border-0 shadow-sm p-4 text-center">
                        ...
                        <h5 class="fw-bold">სახიფათო ტვირთები</h5>
                        <p class="small text-muted">
                            ADR სტანდარტების დაცვით სახიფათო ტვირთების გადაზიდვა.
                        </p>
                    </div>
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <ul class="list-unstyled text-secondary">
                        ...
                        <li class="mb-2"><a href="pages/aboutus.html" class="text-decoration-none text-secondary">ჩვენს
                                შესახებ</a></li>
                        <li class="mb-2"><a href="pages/gallery.html"
                                class="text-decoration-none text-secondary">გალერეა</a></li>
                        <li class="mb-2"><a href="pages/blog.html" class="text-decoration-none text-secondary">ბლოგი</a>
                        </li>
                    </ul>
                </div>
