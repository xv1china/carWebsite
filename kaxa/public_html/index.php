...
<body class="bg-light">
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center gap-3 my-4">
        <div class="card" style="width: 28rem;">
            ...
            <div class="card-body">
                ...
                <a href="aboutus.php#shipping" class="btn btn-primary">წავალთ ყველგან</a>
            </div>
        </div>
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center mt-3 flex-wrap"
        style="gap: 10px; background-color: #0d6efd; text-align: center;"> <img src="assets/images/logo.png">
                ...
                <ul class="card-list swiper-wrapper">
                    ...
                    <?php foreach ($cars as $car): ?>
                        ...
                        $img = !empty($car["first_image"])
                            ? "list-html/assets/uploads/cars/" . (int) $car["id"] . "/" . $car["first_image"]
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 ps-lg-5">
                    ...
                    <a href="aboutus.php" class="btn btn-primary px-4 py-2 mt-3">გაიგეთ მეტი</a>
                </div>
            </div>
        </div>
    </section>
