...
<body class="bg-light">
    ...
    <!-- Old Cards Section -->
    <div class="container-fluid d-flex justify-content-center flex-wrap gap-3 my-4">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                    ...
                    ტრანსპორტირებას, როგორც საქართველოს ტერიტორიაზე.</span>
                        <button id="seeMore1" class="seeMore " onclick="seeMore1()">მეტი</button> '
                    ) ?>
                </p>
                <a href="aboutus.php#shipping" class="btn btn-primary"><?= t('ship_btn', 'ჩვენს შესახებ') ?></a>
            </div>
        </div>
    ...
    <div class="container-fluid d-flex p-4 justify-content-center align-items-center mt-3 flex-wrap"
    ...
    <section class="py-5 bg-light">
        ...
        <div class="container">
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 service-wide">
